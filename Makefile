#############################################################################
# Makefile for building: BresenhamLineDrawing
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  BresenhamLineDrawing.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile BresenhamLineDrawing.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = BresenhamLineDrawing1.0.0
DISTDIR = /home/yioannidis/QtStuff/Projects/BresenhamLineDrawing/obj/BresenhamLineDrawing1.0.0
LINK          = clang++
...
OBJECTS       = obj/NGLScene.o \
		...
		obj/moc_NGLScene.o
DIST          = ../../../NGL/UseNGL.pri \
		BresenhamLineDrawing.pro include/NGLScene.h src/NGLScene.cpp \
		src/main.cpp
QMAKE_TARGET  = BresenhamLineDrawing
...
Makefile: BresenhamLineDrawing.pro ../../../.qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile BresenhamLineDrawing.pro
